...
class TestGetOutgoingrouting_edges(unittest.TestCase):
    ...
    def test_get_outgoing_routing_edges_request(self, mocked_get_obj):
        routing_point = AIDMClasses.RoutingPoint(node_id=1, node_track_id=12)
    ...
    def test_get_outgoing_routing_edges_response_only_node_id(self, mocked_get_obj):
        routing_point = AIDMClasses.RoutingPoint(node_id=161)
        ...
        self.assertIsInstance(routing_edges.routing_edges[0], AIDMClasses.OutgoingRoutingEdge)
        ...
        self.assertIsInstance(routing_edges.routing_edges[1], AIDMClasses.OutgoingRoutingEdge)
        ...
        self.assertIsInstance(routing_edges.routing_edges[2], AIDMClasses.OutgoingRoutingEdge)
    ...
    def test_get_outgoing_routing_edges_response_node_id_response_and_node_track_id(self, mocked_get_obj):
        routing_point = AIDMClasses.RoutingPoint(node_id=1, node_track_id=21)
