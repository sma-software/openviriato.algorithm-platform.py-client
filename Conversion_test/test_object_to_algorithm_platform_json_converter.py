...
class TestFromAIDMConverter(unittest.TestCase):
    ...
    def test_convert_AIDM_object_with_properties_to_convert(self):
        test_train_path_node = aidm. \
            AlgorithmTrainPathNode(id=11038, section_track_id=None, node_id=18, node_track_id=None, formation_id=1187,
                                   ...
                                   stop_status=aidm.StopStatus['operational_stop'], sequence_number=0)
    ...
    def test_convert_AIDM_object_with_properties_is_json_conform_dict(self):
        test_train_path_node = aidm. \
            AlgorithmTrainPathNode(id=11038, section_track_id=None, node_id=18, node_track_id=None, formation_id=1187,
                                   ...
                                   departure_time=datetime.datetime(year=1, month=5, day=1, hour=1, minute=1),
                                   minimum_run_time=None, minimum_stop_time=datetime.timedelta(0),
                                   stop_status=aidm.StopStatus['passing'], sequence_number=0)
    ...
    def test_convert_list(self):
        algorithm_section_track = aidm.AlgorithmSectionTrack(id=12, code='ATest', debug_string='str', weight=8,
