...
import aidm.aidm_routing_point_classes
...
class TestGetIncomingrouting_edges(unittest.TestCase):
    ...
    def test_get_incoming_routing_edges_request(self, mocked_get_obj):
        routing_point = aidm.aidm_routing_point_classes.RoutingPoint(node_id=1, node_track_id=12)
    ...
    def test_get_incoming_routing_edges_response_only_node_id(self, mocked_get_obj):
        routing_point = aidm.aidm_routing_point_classes.RoutingPoint(node_id=161)

        routing_edges = self.interface_to_viriato.get_incoming_routing_edges(routing_point)
        self.assertIsInstance(routing_edges, aidm.IncomingRoutingEdgeSet)
        self.assertIsInstance(routing_edges.routing_edges[0], aidm.IncomingRoutingEdge)
        ...
        self.assertIsInstance(routing_edges.routing_edges[1], aidm.IncomingRoutingEdge)
        ...
        self.assertIsInstance(routing_edges.routing_edges[2], aidm.IncomingRoutingEdge)
    ...
    def test_get_incoming_routing_edges_response_node_id_and_node_track_id(self, mocked_get_obj):
        routing_point = aidm.aidm_routing_point_classes.RoutingPoint(node_id=1, node_track_id=21)
