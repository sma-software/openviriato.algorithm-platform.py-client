...
class TestDetectConflicts(unittest.TestCase):
    ...
    def test_detect_conflicts_response(self, mocked_get_obj):
        ...
        self.assertEqual(list_of_algorithm_conflicts[4].time_window.from_time, datetime.datetime(day=14, month=3, year=2023, hour=15, minute=36, second=10))
        self.assertEqual(list_of_algorithm_conflicts[4].time_window.to_time, datetime.datetime(day=14, month=3, year=2023, hour=15, minute=37, second=0))
        ...
        self.assertEqual(list_of_algorithm_conflicts[5].time_window.from_time, datetime.datetime(day=14, month=3, year=2023, hour=15, minute=36, second=10))
        self.assertEqual(list_of_algorithm_conflicts[5].time_window.to_time, datetime.datetime(day=14, month=3, year=2023, hour=15, minute=37, second=0))
