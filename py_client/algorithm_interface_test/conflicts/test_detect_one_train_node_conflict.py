...
from py_client.aidm.aidm_conflict import ConflictDetectionArguments, _AlgorithmNodeConflict, AlgorithmOneTrainNodeConflict, ConflictType
...
class TestDetectConflicts(unittest.TestCase):
    ...
    def test_detect_conflicts_mock_session(self, mocked_get_obj):
        ...
        self.assertDictEqual(session_obj._DetectConflictsMockSession__last_body, {'trainIds': [2743]})
