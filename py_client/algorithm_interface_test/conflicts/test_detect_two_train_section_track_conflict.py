...
class TestDetectConflicts(unittest.TestCase):
    ...
    def test_detect_conflicts_mock_session(self, mocked_get_obj):
        ...
        self.assertDictEqual(session_obj._DetectConflictsMockSession__last_body, {'trainIds': [1238, 1226], 'filters': {'location': {'nodeIds': None, 'sectionTrackIds': None}, 'conflictTypes': None}})
