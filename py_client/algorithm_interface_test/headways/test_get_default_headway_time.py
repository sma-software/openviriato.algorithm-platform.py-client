...
class TestGetDefaultHeadwayTime(unittest.TestCase):
    ...
    def test_get_default_headway_time_request_section_track_only(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj._GetDefaultHeadwayTimeTestMockSession__last_request, get_api_url() + "/section-tracks/5332/headway-times")
    ...
    def test_get_default_headway_time_request_all_parameters_defined(self, mocked_get_obj):
        ...
        self.assertDictEqual(session_obj._GetDefaultHeadwayTimeTestMockSession__last_body, dict(fromNodeId=125, toNodeId=50))
