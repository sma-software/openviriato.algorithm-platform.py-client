...
class TestGetHeadwayTimeForTrainPathNodesOnSectionTrack(unittest.TestCase):
    ...
    def test_get_headway_time_for_train_path_nodes_on_section_track_request(self, mocked_get_obj):
        ...
        self.interface_to_viriato.get_headway_time_for_train_path_nodes_on_section_track(
            proceeding_node_id, succeeding_node_id, section_track_id, from_node_id, to_node_id
        )

        session_obj = self.interface_to_viriato._AlgorithmInterface__communication_layer.currentSession
        self.assertEqual(
            session_obj._GetHeadwayTimeForTrainPathNodesOnSectionTrackTestMockSession__last_request,
            get_api_url() + "/headway-times/between-train-path-nodes/4246/2/for-section-track/9998/in" "-direction/162/348",
        )
    ...
    def test_get_headway_time_for_train_path_nodes_on_section_track_response(self, mocked_get_obj):
        ...
        self.assertIsInstance(headway_timedelta, timedelta)
        self.assertEqual(timedelta(seconds=174), headway_timedelta)
