...
class TestGetPreferredRoutesThroughNode(TestCase):
    class GetPreferredRoutesThroughNodeTestMock(SessionMockTestBase):
    ...
    @mock.patch("requests.Session", side_effect=GetPreferredRoutesThroughNodeTestMock)
    ...
    def test_get_preferred_routes_request_all_arguments(self, mocked_get_obj):
        ...
        self.interface_to_viriato.get_preferred_routes_through_node(node_id, start_section_track_id, end_section_track_id)

        session_obj = self.interface_to_viriato._AlgorithmInterface__communication_layer.currentSession

        self.assertEqual(session_obj.last_request, get_api_url() + "/nodes/1082/preferred-routes")
        self.assertEqual(session_obj.last_body, {"startSectionTrackID": 123, "endSectionTrackID": 1123, "endInNode": False, "startInNode": False})
    ...
    def test_get_preferred_routes_request_only_node_id(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj.last_body, {"startSectionTrackID": None, "endSectionTrackID": None, "endInNode": False, "startInNode": False})
    ...
    def test_get_preferred_routes_request_node_id_and_start_section_track_id(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj.last_body, {"startSectionTrackID": 2000, "endSectionTrackID": None, "endInNode": False, "startInNode": False})
    ...
    def test_get_preferred_routes_request_node_id_and_end_section_track_id(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj.last_body, {"startSectionTrackID": None, "endSectionTrackID": 1231211, "endInNode": False, "startInNode": False})
    ...
    def test_get_preferred_routes_return(self, mocked_get_obj):
        ...
        start_section_track_id = 123
        end_section_track_id = 1123
        test_routes = self.interface_to_viriato.get_preferred_routes_through_node(node_id, start_section_track_id, end_section_track_id)
        ...
        self.assertEqual(first_routing_edge_pair.outgoing_routing_edge.start_node_track_id, 19)
        self.assertEqual(first_routing_edge_pair.outgoing_routing_edge.end_section_track_id, 1205)
        ...
        self.assertIsInstance(second_routing_edge_pair.outgoing_routing_edge, OutgoingNodeTrackRoutingEdge)
        self.assertEqual(second_routing_edge_pair.outgoing_routing_edge.node_id, 18)
        self.assertEqual(second_routing_edge_pair.outgoing_routing_edge.start_node_track_id, 19)
        self.assertEqual(second_routing_edge_pair.outgoing_routing_edge.end_section_track_id, 1205)
        ...
        self.assertIsInstance(third_routing_edge_pair.outgoing_routing_edge, OutgoingNodeTrackRoutingEdge)
