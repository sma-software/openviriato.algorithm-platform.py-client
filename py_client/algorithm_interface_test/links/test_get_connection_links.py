...
from py_client.aidm import TimeWindow, AlgorithmConnectionLink, LinkType
...
class TestGetConnectionLinks(unittest.TestCase):
    ...
    def test_get_links_request(self, mocked_get_obj):
        ...
        self.assertDictEqual(
            ...
            dict(fromTime="2000-01-01T01:01:00", toTime="2004-01-01T00:00:00", linkType='connection'))
