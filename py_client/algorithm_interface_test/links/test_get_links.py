...
class TestGetLinks(unittest.TestCase):
    ...
    def test_get_links_request(self, mocked_get_obj):
        ...
        self.assertDictEqual(session_obj.last_body, dict(nodeFilter=None, linkType=None, fromTime="2000-01-01T01:01:00", toTime="2004-01-01T00:00:00"))
    ...
    def test_get_links_two_links_as_response(self, mocked_get_obj):
        ...
        self.assertEqual(algorithm_algorithm_await_arrival_link.minimum_duration, timedelta(seconds=600))
