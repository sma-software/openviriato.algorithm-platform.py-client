...
class TestGetAlgorithmTrainParameter(unittest.TestCase):
    ...
    def test_get_algorithm_train_parameter_request(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj._GetAlgorithmTrainParameterTestSessionMock__last_request, get_api_url() + "/parameters/somTestTrainParameterKey")
    ...
    def test_get_algorithm_train_parameter_response(self, mocked_get_obj):
        ...
        self.assertIsInstance(test_algorithm_train.train_path_nodes[0], aidm_train_path_node_classes.AlgorithmTrainPathNode)
