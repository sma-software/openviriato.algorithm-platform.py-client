...
class TestRunningTimePenalties(unittest.TestCase):
    ...
    def test_get_section_running_time_penalties(self, mocked_get_obj):
        requested_time_window = py_client.aidm.aidm_time_window_classes.TimeWindow(
            from_time=datetime.datetime(2003, 4, 30, 18, 0),
            to_time=datetime.datetime(2003, 5, 31, 1, 0))
    ...
    def test_get_section_running_time_penalties_response(self, mocked_get_obj):
        ...
        self.assertIsInstance(
            ...
            py_client.aidm.aidm_running_time_penalty_classes.AlgorithmSectionRunningTimePenalty)
        self.assertEqual(
        ...
        self.assertIsInstance(
            ...
            py_client.aidm.aidm_running_time_penalty_classes.AlgorithmSectionRunningTimePenaltyTrack)
        self.assertEqual(
