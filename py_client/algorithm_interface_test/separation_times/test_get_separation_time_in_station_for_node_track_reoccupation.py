...
class TestGetSeparationTimeInStationForNodeTrackReoccupation(unittest.TestCase):
    ...
    def test_get_separation_time_in_station_for_node_track_reoccupation_request(self, mocked_get_obj):
        ...
        self.assertEqual(
            session_obj._GetSeparationTimeInStationForNodeTrackReoccupationTestMockSession__last_request, get_api_url() + "/nodes/1123/separation-times"
        )
        self.assertDictEqual(session_obj._GetSeparationTimeInStationForNodeTrackReoccupationTestMockSession__last_body, dict(nodeTrackId=123))
