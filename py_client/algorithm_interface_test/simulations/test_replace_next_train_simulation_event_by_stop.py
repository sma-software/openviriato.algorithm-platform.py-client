...
from py_client.aidm.aidm_train_simulation_classes import AlgorithmTrainSimulationEventType, \
    AlgorithmTrainSimulationRealizationForecast, AlgorithmTrainSimulationEvent
...
class TestReplaceNextTrainSimulationEventByStop(unittest.TestCase):
    ...
    def test_replace_next_train_simulation_event_by_stop(self, mocked_post_obj):
        ...
        self.assertDictEqual(
            session_obj._ReplaceNextTrainSimulationEventByStopMockSession__last_body,
            {})
