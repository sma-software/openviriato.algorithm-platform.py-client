...
class TestGetTrainClassifications(unittest.TestCase):
    ...
    def test_cancel_train_request(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj._CancelTrainTestMockSession__last_request, get_api_url() + "/trains/8124")
        self.assertDictEqual(session_obj._CancelTrainTestMockSession__last_body, {})
