...
class TestCancelTrainAfter(unittest.TestCase):
    ...
    def test_cancel_train_after_request(self, mocked_post_obj):
        ...
        self.assertEqual(session_obj._CancelTrainAfterTestMockSession__last_request, get_api_url() + "/trains/8116/train-path-nodes/8114:cancel-after")
