...
class TestCancelTrainTo(unittest.TestCase):
    class CancelTrainToTestMockSession(SessionMockTestBase):
        def put(self, request, json):
            ...
            json_string = (
                ' {  "ID": 8120, "code":"123", "TrainPathNodes": [\n'
                "                {\n"
                '                  "ID": 8118,\n'
                '                  "SectionTrackID": null,\n'
                '                  "node_id": 15,\n'
    ...
    def test_cancel_train_before_request(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj._CancelTrainToTestMockSession__last_request, get_api_url() + "/trains/8120/train-path-nodes/8118:cancel-before")
