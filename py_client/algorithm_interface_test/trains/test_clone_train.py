...
class TestCloneTrain(unittest.TestCase):
    class CloneTrainTestMockSession(SessionMockTestBase):
        def post(self, request, json):
            ...
            json_string = (
                '{  "ID": 11037, "code": "Test",  "TrainPathNodes": [\n'
                "    {\n"
                '      "ID": 11038,\n'
                '      "SectionTrackID": null,\n'
                '      "node_id": 18,\n'
    ...
    def test_clone_train_response(self, mocked_get_obj):
        ...
        self.assertIsInstance(test_cloned_algorithm_train.train_path_nodes[0], aidm_train_path_node_classes.AlgorithmTrainPathNode)
