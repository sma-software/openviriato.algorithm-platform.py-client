...
class TestGetTrainsCutToTimeRangeDrivingAnyNode(unittest.TestCase):
    ...
    def test_get_trains_cut_to_time_range_driving_any_node_request(self, mocked_get_obj):
        ...
        self.assertEqual(session_obj._GetTrainsCutToTimeRangeDrivingAnyNodeTestMockSession__last_request, get_api_url() + "/trains")
        self.assertDictEqual(
            session_obj._GetTrainsCutToTimeRangeDrivingAnyNodeTestMockSession__last_params,
            dict(fromTime="2000-01-01T01:01:00", toTime="2004-01-01T00:00:00", cutTrain=True),
        )
    ...
    def test_get_trains_cut_to_time_range_driving_any_node_response(self, mocked_get_obj):
        ...
        listed_algorithm_trains = self.interface_to_viriato.get_trains_cut_to_time_range_driving_any_node(time_window, filter_node_ids=node_ids)
