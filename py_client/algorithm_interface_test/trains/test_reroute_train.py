...
class TestRerouteTrain(unittest.TestCase):
    ...
    def test_reroute_train_request(self, mocked_session):
        ...
        test_route = UpdateTrainRoute(
            end_train_path_node_id=end_train_path_node_id, start_train_path_node_id=start_train_path_node_id, routing_edges=routing_edges
        )
        ...
        self.assertListEqual(session_obj.last_body["routingEdges"], expected_routing_edge_body)
        self.assertDictEqual(session_obj.last_body["routingEdges"][0], expected_routing_edge_body[0])
        self.assertEqual(session_obj.last_body["startTrainPathNodeId"], 2424)
        self.assertEqual(session_obj.last_body["endTrainPathNodeId"], 3152)
