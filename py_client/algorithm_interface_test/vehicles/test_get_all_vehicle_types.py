...
class TestGetAllVehicleTypes(unittest.TestCase):
    ...
    def test_get_vehicle_type_response(self, mocked_get_obj):
        ...
        self.assertIsInstance(test_algorithm_vehicle_types[2], py_client.aidm.aidm_algorithm_classes.AlgorithmVehicleType)
        self.assertEqual(test_algorithm_vehicle_types[2].debug_string, "vehicle isEngine: True, model: ICN, series: 1, velMax: 200, seats: 125 326")
