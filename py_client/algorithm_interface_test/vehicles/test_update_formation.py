...
class TestUpdateFormation(unittest.TestCase):
    ...
    def test_update_formation_request_with_with_four_parameters(self, mocked_get_obj):
        ...
        self.interface_to_viriato.update_train_formation(formation_id, train_id, from_train_path_node_id, to_train_path_node_id)

        session_obj = self.interface_to_viriato._AlgorithmInterface__communication_layer.currentSession
        self.assertEqual(session_obj.last_request, get_api_url() + "/trains/1234/train-path-nodes:update-formation")
        self.assertDictEqual(session_obj.last_body, dict(formationID=1551, fromTrainPathNodeID=11037, toTrainPathNodeID=11038))
    ...
    def test_update_formation_request_with_with_three_parameters(self, mocked_get_obj):
        ...
        self.assertDictEqual(session_obj.last_body, dict(formationID=1551, fromTrainPathNodeID=11037, toTrainPathNodeID=None))
    ...
    def test_update_formation_response_with_with_four_parameters(self, mocked_get_obj):
        ...
        updated_train = self.interface_to_viriato.update_train_formation(formation_id, train_id, from_train_path_node_id, to_train_path_node_id)
    ...
    def test_update_formation_response_with_with_three_parameters(self, mocked_get_obj):
        ...
        updated_train = self.interface_to_viriato.update_train_formation(formation_id, train_id, from_train_path_node_id)
