...
class TestCommunicationLayerToRaiseHTTPError(unittest.TestCase):
    ...
    def test_do_post_request_to_raise_HTTPError(self):
        responses.add(**dict(method=responses.POST, url="http://viriato.rest.ch/api/post_to_raise_HTTPError", body="", status=400))
    ...
    def test_do_put_request_to_raise_HTTPError(self):
        responses.add(**dict(method=responses.PUT, url="http://viriato.rest.ch/api/put_to_raise_HTTPError", body="", status=400))
