...
class TestCommunicationLayerToReturnJson(unittest.TestCase):
    ...
    def test_requests_that_return_json(self):
        responses.add(**dict(method=responses.GET, url="http://viriato.rest.ch/api/get_request_that_returns_json", body='{"key" : "Value"}', status=200))
    ...
    def test_do_post_request_to_return_json(self):
        responses.add(**dict(method=responses.POST, url="http://viriato.rest.ch/api/post_request_that_returns_json", body='{"key" : "Value"}', status=200))
    ...
    def test_do_put_request_to_return_json(self):
        responses.add(**dict(method=responses.PUT, url="http://viriato.rest.ch/api/put_request_that_returns_json", body='{"key" : "Value"}', status=200))
