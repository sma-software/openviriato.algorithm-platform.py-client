...
from py_client.conversion.json_to_aidm_processors import AidmWithOnlyPrimitivesProcessor, JsonToAidmProcessor
...
class JsonToAidmConverter:
    ...
    def __init__(self):
        self.__processors = [AidmWithOnlyPrimitivesProcessor()]
