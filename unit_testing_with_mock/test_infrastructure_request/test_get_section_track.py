...
class TestGetDirectedSectionTracks(unittest.TestCase):
    ...
    @mock.patch('requests.Session', side_effect=GetDirectedSectionTracksSessionTestMock)
    def not_atest_get_directed_section_tracks_request(self, mocked_get_obj):
    ...
    @mock.patch('requests.Session', side_effect=GetDirectedSectionTracksSessionTestMock)
    def not_atest_get_directed_section_tracks_return(self, mocked_get_obj):
    ...
    def not_atest_get_directed_section_tracks_str_parameters(self):
