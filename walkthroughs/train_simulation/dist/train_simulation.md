...
[update_train_times(...)](../../../py_client/algorithm_interface/algorithm_interface.py#L292-L292) of the Algorithm Interface. The changed trains can then be saved to a regular Viriato train scenario, persisting the realised train runs. 
